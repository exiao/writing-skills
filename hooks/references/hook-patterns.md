...
## 20. Episodic Numbering (Series Hook)

**Psychology:** The episode number is a standing open loop that spans posts, not seconds. A bounded season ("1/100") tells the viewer this is a limited show worth following to completion; it converts a one-time viewer into a follower because they want the rest of the run. Bounded beats infinite: "all 100" creates completion desire, "daily forever" creates fatigue. (Source: @anuatluru + @rohanrkumar, Jul 2026 — IG skit account captioning "1/100" pulled 35K likes/5.1K sends per post.)

**Template:**
- "[N]/[total]" as the caption or opening frame ("1/100", "ep 12 of 100")
- "part [N]: [payoff of this episode]"
- "[recurring character/format], episode [N]"

**Examples:**
- "1/100: one honest stock take, every episode"
- "ep 7: the panic seller meets a red day"
- "part 3: what the 10-K actually said"

**Best for:** Account growth (follower conversion), skit series with recurring characters, bounded challenge runs, any format meant to repeat

**Pitfall:** Use episode numbers ("ep 12"), not day numbers ("day 12"), when posting cadence isn't guaranteed — episode counts survive skipped days; broken date streaks read as abandonment. Numbering without a recognizable recurring format is just a caption.
